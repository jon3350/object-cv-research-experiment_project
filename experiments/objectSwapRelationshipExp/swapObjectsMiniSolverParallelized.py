...
if __name__=="__main__":
    ...
    dataset_path = "/n/fs/obj-cv/infinigen_project/savedDatasets/livingRoom99" # original dataset
    index = 109
    ...
    # read the pd as csv ARG NOT DEFINED BY PARSER
    ...
    # Don't do jobs that have already been rendered
    image_name = f"{index}#{scene_id}#{target}"
    if os.path.exists(f"{os.path.join(output_folder, image_name )}.png"):
        sys.exit()
